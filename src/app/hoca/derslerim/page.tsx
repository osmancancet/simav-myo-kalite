...
import {
    ...
    FileText, CheckCircle, Clock, Award, TrendingUp, GraduationCap
} from "lucide-react"
import { Button } from "@/components/ui/button"

export const dynamic = "force-dynamic"

export default async function HocaDerslerim() {
            ...
            {activeSemester && (
                <div className="flex items-center gap-3 p-4 rounded-xl bg-violet-500/10 border border-violet-500/20">
                    ...
                    <span className="text-violet-300">
                        Aktif Dönem: <strong className="text-white">{activeSemester.name}</strong>
                    </span>
                </div>
            )}
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 mt-1">Sınav kağıtlarınızı yükleyin ve yönetin</p>
                    </div>
                </div>
                ...
                <Card className="bg-slate-800/30 border-2 border-dashed border-slate-700">
                    <CardContent className="py-20 text-center">
                        ...
                        <p className="text-slate-400 mb-8 max-w-md mx-auto">
                            ...
                            Her ders için vize, final ve bütünleme dosyalarınızı yükleyebilirsiniz.
                        </p>
                        <Link href="/hoca/ders-ekle">
                                            ...
                                            <div className="mb-4">
                                                <div className="flex items-center justify-between text-sm mb-2">
                                                    ...
                                                    <span className={`font-medium ${isComplete ? 'text-emerald-400' : 'text-blue-400'}`}>
                                                        {completed}/{examCount} sınav tamamlandı
                                                    </span>
                                                </div>
                                        ...
                                        {!hasExams && (
                                            <div className="mt-4 p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
                                                <p className="text-sm text-blue-300 flex items-center gap-2">
                                                    ...
                                                    Henüz sınav eklenmedi, tıklayın ve başlayın!
                                                </p>
                                            </div>
                                        )}
                                    </CardContent>
