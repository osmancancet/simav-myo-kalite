...
import {
    ...
    Plus, BookOpen, BarChart2, TrendingUp
} from "lucide-react"
import Link from "next/link"
import { notFound, redirect } from "next/navigation"
import { AddExamDialog } from "@/app/hoca/ders/[id]/add-exam-dialog"
import { ExamCard } from "@/app/hoca/ders/[id]/exam-card"
...
export default async function AdminCourseDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Verify ownership - admin can only access their own courses here
    if (course.instructor.email !== session.user.email) {
        redirect("/admin/derslerim")
    }
